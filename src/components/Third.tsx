...
const Third = () => {
  ...
  return (
    <main className="flex text-white items-center justify-between main text-[32px] leading-[36px] font-[600]">
      <div
        className={`flex transition-all items-center w-full gap-[64px] ease-out h-full ${
          hovered && hovered !== null && 'gap-[32px]'
        }`}
      >
        {sections.map((section) => (
          <div
            ...
            } justify-center  gap-[32px] text-center h-full relative group ease-out duration-300 items-center`}
