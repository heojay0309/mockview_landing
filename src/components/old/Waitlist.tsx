...
const Waitlist = () => {
  ...
  return (
    <div className=" bg-white hover:animate-none  shadow-lg shadow-gray-400 items-start justify-between border border-transparent rounded-lg tablet:p-16 p-[16px]">
