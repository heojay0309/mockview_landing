const TermsOfUse = () => {
  return (
    <div className="flex flex-col gap-[32px] leading-[30px] text-white tracking-widest py-[64px] px-[64px] h-full overflow-y-scroll">
      ...
      <h2 className="text-[24px] md:text-[32px] font-[500]">Use of Service</h2>
      <div className="md:pl-6 text-[14px] md:text-[18px]">
