...
const PrivacyPolicy = () => {
  return (
    <div className="flex flex-col gap-[32px] text-[14px] md:text-[18px] leading-[30px] text-white tracking-widest py-[64px] px-[64px] h-full overflow-y-scroll">
      ...
      <section id="2" className="flex flex-col gap-[16px]">
        ...
        <div className="flex flex-row gap-[16px] flex-wrap">
          ...
          <div className="pl-6 gap-[16px] flex flex-col">
            <li>
              <span className="font-bold">
